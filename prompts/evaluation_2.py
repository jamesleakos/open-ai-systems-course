# AUTOMATED TESTING
# COMPARE TO IDEAL OUTPUTS that aren't deterministic - might be many right answers
# we use a rubric and run it through the model
...
# the rubric below is what OpenAI uses!
